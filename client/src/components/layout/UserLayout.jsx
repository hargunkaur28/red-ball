    ...
    <>
      <div className="flex items-center justify-between px-4 h-16 border-b border-[#EAEAEA] shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-[#111111]">Red Ball Academy</span>
        </div>
      ...
      <div className="border-t border-[#EAEAEA] p-3 shrink-0">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="overflow-hidden"><p className="text-sm font-medium text-[#111111] truncate">{user?.name}</p><p className="text-xs text-[#888888]">{user?.role}</p></div>
        </div>
    ...
    <div className="min-h-screen bg-[#F7F7F7] flex">
      ...
      <div className="flex-1 lg:ml-64">
        <header className="h-14 border-b border-[#EAEAEA] bg-white/80 backdrop-blur-md sticky top-0 z-30 flex items-center px-4 lg:px-6 lg:hidden">
          ...
          <span className="ml-3 text-sm font-semibold text-[#111111]">My Account</span>
        </header>

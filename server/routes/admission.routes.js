...
router.get('/pending-fees', auth, authorize('superadmin', 'admin'), admissionController.getPendingFees);
router.get('/', auth, authorize('superadmin', 'admin', 'receptionist'), admissionController.getAll);
router.post('/', auth, authorize('superadmin', 'admin'), admissionController.create);
